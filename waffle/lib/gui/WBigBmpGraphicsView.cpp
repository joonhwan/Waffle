...
void WBigBmpGraphicsView::ZoomIn()
{
    scaleView(qreal(2.));
}

void WBigBmpGraphicsView::ZoomOut(void)
{
    scaleView(qreal(1./2.));
}

void WBigBmpGraphicsView::ResetZoom(void)
{
	fitInView(scene()->itemsBoundingRect(), Qt::KeepAspectRatio);
}

void WBigBmpGraphicsView::zoom(qreal factor, QPointF centerPoint)
{
    scale(factor, factor);
...
qreal WBigBmpGraphicsView::zoomLevel(void) const
{
...
void WBigBmpGraphicsView::wheelEvent ( QWheelEvent * e)
{
	//if(!m_panning)
...
//virtual
void WBigBmpGraphicsView::mousePressEvent(QMouseEvent* event)
{
	__super::mousePressEvent(event);
}

//virtual
void WBigBmpGraphicsView::mouseReleaseEvent(QMouseEvent *event)
{
...
//virtual
void WBigBmpGraphicsView::mouseMoveEvent(QMouseEvent* e)
{
	__super::mouseMoveEvent(e);
}

//virtual
void WBigBmpGraphicsView::keyPressEvent(QKeyEvent* event)
{
	switch(event->key())
	{
	case Qt::Key_Space:
...
//virtual
void WBigBmpGraphicsView::keyReleaseEvent(QKeyEvent * event)
{
...
void WBigBmpGraphicsView::scaleView(qreal scaleFactor)
{
