...
WTransparentProgressBar::WTransparentProgressBar(QWidget *parent)
	: QProgressBar(parent)
...
WTransparentProgressBar::~WTransparentProgressBar()
{
}

void WTransparentProgressBar::setOpacity(qreal opacity)
{
...
void WTransparentProgressBar::onValueChanged(int value)
{
...
//virtual
void WTransparentProgressBar::paintEvent(QPaintEvent* e)
{
