...
bool isUacAvailable()
{
	// UAC is available if windows vista or later
...
//     }
//
bool isUserInAdminGroup(quint32* errorCode)
{
...
//     }
//
bool isRunAsAdmin(quint32* errorCode)
{
...
//     }
//
bool isProcessElevated(quint32* errorCode)
{
...
//     }
//
quint32 GetProcessIntegrityLevel(quint32* errorCode)
{
