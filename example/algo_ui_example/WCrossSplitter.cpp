...
void WCrossSplitter::setHorizontalStretchFactor(int index, int factor)
{
	m_horzUp->setStretchFactor(index, factor);
	m_horzDown->setStretchFactor(index, factor);
}

void WCrossSplitter::setVerticalStretchFactor(int index, int factor)
{
	m_vert->setStretchFactor(index, factor);
}
